...
// int main(){
//     arma::mat state_vector_1 =  test_obj.get_state_vector();
//     for(int i = 0; i < m; i++){
//         // prediction step 1
//         state_vector_1 = test_obj.updated_state_vector(V_twist);
...
//         // // //update step 1
//         arma::mat z_hat = test_obj.calculate_z_hat(i);
//         z_hat.print("step 8: z_hat");

//         // //update step 2
//         arma::mat h = test_obj.calculate_h(i);
//         h.print("step 10: H");
...
//         arma::mat z = test_obj.calculate_z(i);
//         z.print("step 14: z");
...
//         state_vector_1 = state_vector_1 + k_delta;
